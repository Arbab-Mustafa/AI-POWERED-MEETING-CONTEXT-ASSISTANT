...
export default function MeetingDetailPage() {
  ...
  const { currentMeeting, fetchMeeting, isLoading: meetingLoading } = useMeetingStore();
  const { 
    currentContext, 
    fetchContext, 
    generateContext,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">{currentMeeting.title}</h2>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-900">
                      {format(new Date(currentMeeting.start_time), "MMMM dd, yyyy")}
                    </p>
                ...
                {currentMeeting.attendees && currentMeeting.attendees.length > 0 && (
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-700">Attendees ({currentMeeting.attendees.length})</p>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              {isGenerating && (
                <div className="flex flex-col items-center justify-center py-16">
                  ...
                  <p className="text-lg font-medium text-gray-900">Generating AI Context...</p>
                  <p className="text-sm text-gray-500 mt-2">Mistral AI is analyzing your meeting</p>
                </div>
              )}
              ...
              {!isGenerating && !currentContext && (
                <div className="text-center py-16">
                  ...
                  <p className="text-lg text-gray-600 mb-2">No AI context generated yet</p>
                  <p className="text-sm text-gray-500">Click "Generate Context" to get AI-powered insights</p>
                </div>
              )}
              ...
              {currentContext && !isGenerating && (
                <div className="space-y-6">
                  ...
                  <div className="bg-gradient-to-br from-purple-50 to-blue-50 rounded-lg p-5 border-l-4 border-purple-500">
                    <div className="flex items-center justify-between mb-3">
                      <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-purple-100 text-purple-800">
                        {currentContext.meeting_type.replace('_', ' ').toUpperCase()}
                      </span>
                      <span className="text-xs text-gray-500">
                        Confidence: {currentContext.confidence_score}%
                      </span>
                    </div>
                    <p className="text-gray-800 leading-relaxed">{currentContext.ai_brief}</p>
                  </div>

                  {/* Key Topics */}
                  {currentContext.key_topics && currentContext.key_topics.length > 0 && (
                    <div>
                  ...
                  {currentContext.preparation_checklist && currentContext.preparation_checklist.length > 0 && (
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-3 flex items-center space-x-2">
                        <span>✅</span>
                      ...
                      <ul className="space-y-2">
                        {currentContext.preparation_checklist.map((item, idx) => (
                  ...
                  {/* Attendee Context */}
                  {currentContext.attendee_context && Object.keys(currentContext.attendee_context).length > 0 && (
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-3 flex items-center space-x-2">
                        <span>👥</span>
                      ...
                      <div className="space-y-2">
                        {Object.entries(currentContext.attendee_context).map(([email, context]) => (
                          <div key={email} className="p-3 bg-blue-50 rounded-lg">
